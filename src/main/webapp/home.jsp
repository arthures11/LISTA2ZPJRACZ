...
<%
    ...
    String delete = "DROP ALL OBJECTS";
    String sql = "Create table users (id integer generated by default as identity,password varchar(255),username varchar(255),primary key (id))";
    String sql_posty = "Create table post (postID integer generated by default as identity,pytanie varchar(255),post_author varchar(255),post_data varchar(255),liczba_odpowiedzi int,primary key (postID))";
    String sql_odp = "Create table odpowiedzi (id integer generated by default as identity,odp_author varchar(255),tresc varchar(255),odp_data varchar(255),ocena int,ilosc_ocen int,suma_ocen int,primary key (id),postID int,FOREIGN KEY (postID) REFERENCES post(postID))";
    Statement statement = connection.createStatement();
   // statement.execute(delete);
   // statement.execute(sql);

    //statement.execute(sql_posty);
    //statement.execute(sql_odp);

    System.out.println("created user table.");

    String t = "testy";
    sql = "insert into users (id, password, username) values (default, 'testy', 'testy')";
    String insertPost = "insert into post (postID, pytanie, post_author,post_data,liczba_odpowiedzi) values (default, 'jakies tam pytanie', 'admin', '2022-02-22', 1)";
    String inserOdp = "insert into odpowiedzi (id, odp_author, tresc,odp_data,ocena,ilosc_ocen,suma_ocen,postID) values (default, 'admin', 'iles tam', '10-10-1999',0, 0, 0,1)";

    //statement.executeUpdate(sql);
   // statement.executeUpdate(insertPost);
   // statement.executeUpdate(inserOdp);
  ...
  //  while (resultSet.next()) {
   ...
   // }
    ...
    usrs = helpers.getUserList();
    odpsy = helpers.getodpsList();


    for(int i=0;i<usrs.size();i++){
        System.out.println(usrs.get(i).username+usrs.get(i).id);
    }
    posty = helpers.getPostList();
    for(int i=0;i< odpsy.size();i++){
        System.out.println(odpsy.get(i).PostID+"  "+odpsy.get(i).tresc);
    }
                            ...
                            <div class="container py-4 py-xl-5">
                                <div class="row mb-5">
                                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                                        ...
                                        <p class="w-lg-50" style="font-size: 18px;text-align: left;"><%=posty.get(i).getId()+". "+posty.get(i).getPytanie()%></p>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-xl-6 mx-auto p-4">
                        <div class="d-flex align-items-center align-items-md-start align-items-xl-center">
                            ...
                            <div>
                                <h4><%= posty.get(i).getId()+". "+posty.get(i).getPytanie()%></h4>
